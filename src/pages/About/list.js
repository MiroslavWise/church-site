...
const listPostAbout = [
        ...
        {title: 'Вероучение церкви', description: 'Составлено на основе «Исповедания веры христиан баптистов» под редакцией И. В. Одинцова 1928 г.', photo: beliefs, link: '/about/beliefs'},
